...
import { Package, Clock, CheckCircle, MapPin, Truck, ChevronRight, User, Bike, Car, Loader, Shield, XCircle, Star, AlertCircle, ArrowRight, Box, Scale, Zap, Rocket, Navigation, RefreshCw, FileText, Copy, Check, Send } from 'lucide-react';
...
const HistoryList: React.FC<HistoryListProps> = ({ onTrackOrder, onReorder }) => {
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      {/* Receipt Modal */}
      {viewingReceipt && (
        <ReceiptModal order={viewingReceipt} onClose={() => setViewingReceipt(null)} />
      )}
    </div>
  );
};
